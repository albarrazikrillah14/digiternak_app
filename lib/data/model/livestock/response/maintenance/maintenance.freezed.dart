...
class _$MaintenanceImpl implements _Maintenance {
  _$MaintenanceImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'Maintenance(id: $id, name: $name)';
  }
...
abstract class _Maintenance implements Maintenance {
  factory _Maintenance({required final int id, required final String name}) =
      _$MaintenanceImpl;
